...
( function() {
	...
	divlogo_responsive.innerHTML="<img src='http://172.28.0.120/wordpress/wp-content/uploads/2021/03/logo-molina-responsive.jpg' alt=''>";
	for(let i = 0; i < parentrrss.length; i++){
		...
		buscador_responsive.innerHTML = "<form role='search' method='get' class='search-form search-form-responsive' action='http://172.28.0.120/wordpress/'>"+
		"<button type='submit' class='search-submit'><i class='bi-search'></i></button>"+
